...
export default function Auth() {
  return (
    <main className="lg:ml-[32rem] auth-wrapper">
      ...
      <h1 className="font-canopee text-center pl-[25px] pr-[25px] text-[55px] leading-[100%] sm:text-[85px] lg:text-[97.75px] lg:max-w-[550px] lg:text-left xl:max-w-[700px]">
      ...
      <button className="rounded-[4.56px] max-w-[325px] w-[100%] bg-black pl-[42px] pt-[12px] pb-[12px] mt-[18px] pr-[42px] text-white sm:max-w-[562px] sm:text-[26.08px] lg:max-w-[550px] xl:max-w-[666px]">
